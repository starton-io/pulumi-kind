...
func (o ClusterOutput) ClientCertificate() pulumi.StringOutput {
	return o.ApplyT(func(v *Cluster) pulumi.StringOutput { return v.ClientCertificate }).(pulumi.StringOutput)
}
...
func (o ClusterOutput) Completed() pulumi.BoolOutput {
	return o.ApplyT(func(v *Cluster) pulumi.BoolOutput { return v.Completed }).(pulumi.BoolOutput)
}
...
func (o ClusterOutput) KindConfig() ClusterKindConfigPtrOutput {
	return o.ApplyT(func(v *Cluster) ClusterKindConfigPtrOutput { return v.KindConfig }).(ClusterKindConfigPtrOutput)
}
...
func (o ClusterOutput) KubeconfigPath() pulumi.StringOutput {
	return o.ApplyT(func(v *Cluster) pulumi.StringOutput { return v.KubeconfigPath }).(pulumi.StringOutput)
}
...
func (o ClusterOutput) NodeImage() pulumi.StringOutput {
	return o.ApplyT(func(v *Cluster) pulumi.StringOutput { return v.NodeImage }).(pulumi.StringOutput)
}

// Defines wether or not the provider will wait for the control plane to be ready. Defaults to false.
func (o ClusterOutput) WaitForReady() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v *Cluster) pulumi.BoolPtrOutput { return v.WaitForReady }).(pulumi.BoolPtrOutput)
}
